                ...
                <div className="content justify-content-between" >
                    <div>
                        <span><h1 className="input">
                            <Typewriter
                                words={languageState==="JP"?["こんにちは ", "ローゲシュです ", "フルスタックウェブ開発者"]:[" Hi There ", "I Am Logesh ", "Full Stack Web Developer"]}
                                loop
                                cursor
                                cursorStyle='_'
                                typeSpeed={70}
                    ...
                    <h5 className="text-home">{languageState==="JP"?"私は美しくシンプルなものをコーディングし、デザインし、私は自分の仕事が大好きです。":"I Code and Design Beautifully simple things,I Love What I do."}</h5>
                </div>
                <div className="my-5">
